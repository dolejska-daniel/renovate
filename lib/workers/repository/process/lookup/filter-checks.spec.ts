...
describe('workers/repository/process/lookup/filter-checks', () => {
  ...
  describe('.filterInternalChecks()', () => {
    ...
    it('incorrectly returns latest release if internalChecksFilter=strict, minimumReleaseAge is specified, but the latest release does not have a releaseTimestamp', async () => {
